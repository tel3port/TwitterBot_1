...
def tweet_list_downloader(hash_tag, count_num, language, from_date):
    for single_tweet in tweepy.Cursor(gls.api.search, q="#DogsMostWanted", count=1500, lang="en", since="2019-07-29").items():
